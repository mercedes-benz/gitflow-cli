...
// TestReleaseFinishMaven with Maven plugin and Maven preconditions
func TestReleaseFinishMaven(t *testing.T) {
	...
	env.CommitFile("version.txt", "1.1.0", "Set up test precondition for release branch.", "release/1.1.0")
